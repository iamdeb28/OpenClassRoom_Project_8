...
describe('controller', function () {
	...
	describe('toggle all', function () {
		it('should toggle all todos to completed', function () {
			// TODO: write test
			var todo = {id: 12, title: 'my todo', completed: false};
			setUpModel([todo]);
			...
			expect(model.update).toHaveBeenCalledWith(12, Object({ completed: true }), jasmine.any(Function));
		});
		...
		it('should update the view', function () {
			...
			expect(view.render).toHaveBeenCalledWith('elementComplete', {id: 10, completed: false});
		});
	});
